...
class CreateCapAndRedistributeOptions < ActiveRecord::Migration[8.1]
  def change
    create_table :cap_and_redistribute_options do |t|
    ...
    # Add GIN index for JSONB weights column
    add_index :cap_and_redistribute_options, :weights, using: :gin, name: "index_cap_and_redistribute_options_on_weights_gin"
